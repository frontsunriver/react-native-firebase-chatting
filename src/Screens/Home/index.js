          ...
          <View style={styles.container}>
            <Portal>
              ...
              >
                ...
                <Dialog.Actions>
                  {showLoader == true ? (
                    ...
                    <Button onPress={() => createGroup(groupName, uid)}>
                      Done
                    </Button>
                  )}
                </Dialog.Actions>
              ...
              <Dialog visible={loading} dismissable={false}>
                <Dialog.Title>{loading_dialog_text}</Dialog.Title>
                <Dialog.Content>
                  <ActivityIndicator
                    size={60}
                    animating={true}
            ...
            <Image
              source={
                imageURI == null
                  ? require("../../Assets/image/default_profile.png")
                  : { uri:imageURI }
              }
            ...
            <View style={styles.buttonGroup}>
              ...
              <Button
                ...
                onPress={() => {
                  setLoading(true);
                  setLoadingDialogText("Logging out...");
                  firebase
                    .auth()
                    .signOut()
                    .then(() => {
